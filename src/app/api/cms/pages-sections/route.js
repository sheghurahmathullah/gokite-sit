...
export async function POST(request) {
  try {
    ...
    const upstreamUrl = `${process.env.NEXT_PUBLIC_API_URL}/api/cms/api/v2/list/custom/data/pages-sections`;
    ...
    console.error("API endpoint not working - pages-sections:", err);
