...
const TourInfoCard = ({ tour, onEnquire }: TourInfoCardProps) => {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 max-w-[380px] mx-auto space-y-4 sticky top-4 md:max-w-[440px] md:p-8">
      <h1 className="text-3xl font-bold text-foreground leading-tight">
        {tour.title}
      </h1>

      <div className="flex items-center gap-4 text-base text-black font-medium">
        <div className="flex items-center font-bold text-[#017a6e] gap-1">
      ...
      <Button
        ...
        className="w-full w-fit bg-[#FDB714] hover:bg-[#FDB714]/90 text-foreground font-semibold rounded-lg py-6 text-lg shadow-none"
      >
        Enquire
      </Button>
    </div>
